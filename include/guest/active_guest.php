...
<table class="table table-bordered table-hover">
	...
	<thead>
    	<tr>
        	<th colspan="8" style="padding:2px"><a class="btn btn-info" style="float:right; text-decoration:none" href="home.php?item=11"><i class="glyphicon glyphicon-plus-sign"></i> Add New</a></th>
        </tr>
        <tr>
          <th>Guest Id</th>
          <th>Guest Name</th>

...
<div>
    <a style="text-decoration:none; float:right" href="home.php?item=9" class="btn btn-success">
    	<i class='glyphicon glyphicon-list'></i> Employee list
    </a> 
</div>
 
 <form class="form-horizontal" method="post" action="home.php?item=6" enctype="multipart/form-data">

...
<table class="table table-bordered table-hover">
	<thead>
   <tr>
        	<th colspan="2" style="background-color:#F8F8F8; padding:2px"><a href="home.php?item=17" style="float:right; text-decoration:none" class="btn btn-primary"><i class='glyphicon glyphicon-log-out'></i> Return</a></th>
        </tr>
    </thead>

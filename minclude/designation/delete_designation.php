    ...
    <thead>
    	<tr>
        	<th colspan="4" style="padding:2px">
            	<form method="post" action="home.php?item=9" onSubmit="return confirm('Are you sure delete this records ?')">
                
                <button type="submit" class="btn btn-danger" name="btnDelete" ><i class="glyphicon glyphicon-trash"></i> Delete</button>
             <a class="btn btn-info" style="float:right" href="home.php?item=7"><i class="glyphicon glyphicon-log-out"></i>Return</a>

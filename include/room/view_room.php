...
<table class="table table-bordered table-hover">
    ...
    <tr>
          ...
          <span>
           <a href="home.php?item=15" style="float:right; text-decoration:none" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Add New</a>
          </span>
         </th>
        </tr>
        <tr>
    ...
    <?php
    $room_table = $db->query("select id,room_name,room_no,room_type,description,price,status,image from b_room order by id");

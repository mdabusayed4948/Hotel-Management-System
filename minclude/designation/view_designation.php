...
<table class="table table-bordered table-hover">
    ...
    <thead>
    	<tr>
        	<th colspan="4" style="background-color:#F8F8F8; padding:2px"><a class="btn btn-info" style="float:right" href="home.php?item=6"><i class="glyphicon glyphicon-plus-sign"> Add New</i></a></th>
        </tr>
    	<tr>

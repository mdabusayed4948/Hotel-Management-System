...
<div><a class="btn btn-success" style="text-decoration:none; float:right" href="home.php?item=23"><i class='glyphicon glyphicon-list'></i>  Reservation List</a></div>

<form class="form-horizontal" method="post" action="home.php?item=22">

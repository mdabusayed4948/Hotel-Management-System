<div class="topstyle">
	<h3 class="styl">Occupied Room List </h3>
</div>

<table class="table table-bordered table-hover">
	<thead>
    	<tr>
        	<th colspan="7" style="background-color:#F8F8F8; padding:2px"><a href="home.php?item=15" class="btn btn-primary" style="float:right; text-decoration:none"><i class="glyphicon glyphicon-plus-sign"></i> Add New</a></th>
        </tr>
    ...
    <?php
     $room_table = $db->query("select id,room_name,room_no,room_type,description,price,status,image from b_room where status='Occupied' order by id");

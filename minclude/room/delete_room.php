...
<thead>
    <tr>
        ...
        <form action="home.php?item=22" method="post" onSubmit="return confirm('Are you sure Delete this record?');">
<button type="submit" name="btnDelete" class="btn btn-danger"><i class='glyphicon glyphicon-trash'></i> Delete</button>
<a style="float:right" class="btn btn-info" href="home.php?item=17"><i class='glyphicon glyphicon-log-out'></i> Return</a>

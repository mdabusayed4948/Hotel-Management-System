...
<div style="float:right">
	<a class="btn btn-success" href="home.php?item=32"><i class="glyphicon glyphicon-list"> Designation List</i></a>
</div>

<form class="form-horizontal" method="post" action="home.php?item=31">

...
<div><a style="text-decoration:none; float:right" href="home.php?item=24" class="btn btn-success"><i class="glyphicon glyphicon-list"></i> Reservation List</a></div>
<form class="form-horizontal" method="post" action="home.php?item=25">

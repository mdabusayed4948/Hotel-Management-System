...
<div><a class="btn btn-info" style="float:right" href="home.php?item=28"><i class="glyphicon glyphicon-list"></i> Food List</a></div>

<form class="form-horizontal" method="post" action="home.php?item=27">

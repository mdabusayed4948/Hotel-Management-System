...
<div>
<a href="home.php?item=28" style="float:right; text-decoration:none" class="btn btn-success"><i class="glyphicon glyphicon-list"></i> Food List</a>
</div>
<form method="post" class="form-horizontal" action="home.php?item=29">

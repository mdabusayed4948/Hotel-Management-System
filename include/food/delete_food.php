    ...
    <thead>
    	<tr>
        	<th colspan="5" style="padding:2px">
            	<form method="post" action="home.php?item=37" style="padding:2px" onSubmit="return confirm('Are you sure Delete this record ?');">
                	<button type="submit" class="btn btn-danger" name="btnDelete"><i class="glyphicon glyphicon-trash"></i> Delete</button>
                    <a style="float:right" class="btn btn-info" href="home.php?item=35"><i class="glyphicon glyphicon-log-out"></i> Return</a>

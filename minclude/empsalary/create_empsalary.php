...
<?php
	if(isset($_POST["btnSubmit"])){
		...
		if(count($errors)==0){
			$db->query("insert into b_exp(employee_id,source,billdate,paidamount,dueamount,status) values('$empid','$source','$date','$pamount','$damount','$status')");
...
<div><a class="btn btn-success" style="text-decoration:none; float:right" href="home.php?item=36"><i class='glyphicon glyphicon-list'></i>  Employee Salary List</a></div>

<form class="form-horizontal" method="post" action="home.php?item=35">

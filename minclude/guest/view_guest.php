...
<table class="table table-bordered table-hover">
	...
	<thead>
    	<tr>
          ...
          <form action="home.php?item=11" method="post">
          ...
          <a href="home.php?item=10"  text-decoration:none" class="btn btn-primary">
	  ...
	  while(list($id,$name,$gender,$email,$contact,$address,$status)=$guest_table->fetch_row()){ ?>
		<tr>
			...
			if($status=='Active'){
				 ...
				 echo "<i class='glyphicon glyphicon-remove' style='color:red; text-align:center'></i>";
				}
